...
为了回应“范围划大一些、更稀疏”的要求，还额外测试了 wide 区域。

| 配置 | 候选基站 | 用户 | 服务器 | 用户范围 | Stage I 优势 | PSP 结果 |
|---|---:|---:|---:|---:|---:|---|
| `wide_c40_u130_k10` | 40 | 130 | 10 | 10.73 km x 14.55 km | 最高 28.29% | 有一组 seed 42 三项最优，但多 seed 不稳 |
| `wide_c50_u180_k15` | 50 | 180 | 15 | 14.73 km x 13.72 km | 最高 28.01% | PSP 未稳定最优 |

wide 区域说明：

这些组确实比原始 10_130 和主候选区域更宽、更稀疏，但 Stage II PSP 的优势不如主候选稳定。因此不建议作为主图；可以作为内部探索或 response letter 中的补充说明。
